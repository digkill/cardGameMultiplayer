...
import {getState, isHost, onPlayerJoin, useMultiplayerState, usePlayersList} from "playroomkit";
import {randInt} from "three/src/math/MathUtils.js";
import {useFaceControls} from "@react-three/drei";
...
export const GameEngineProvider = ({children}) => {
    ...
    // we sort players by id to have a consistent order through all clients
    ...
    const distributeCards = (nbCards) => {
        ...
        players.forEach((player) => {
            ...
            for (let i = 0; i < nbCards; i++) {
                const randomIndex = randInt(0, newDeck.length)
            ...
            case 'playerAction':
                ...
                if (newPlayerTurn === getState("playerStart")) {
                    ...
                    if (getState("round") === NB_ROUNDS) {
                        ...
                        // we change the player who starts
